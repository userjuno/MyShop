...
<body onLoad="regFrm.id.focus()">
   ...
   <div class="aside_wrap">
    ...
    <div class="contents" style="padding-top: 70px;">
            ...
            <div class="up_form">
                <form name="infoFrm" method="post" action="reginfo1.jsp" >
                    		
                    <input name ="pwd" style="margin: 2.5% 0;" type="password" id="M_t" class="Mo_pw2" placeholder="비밀번호">
                    <input type="button" id="M_t" style="text-align: center;" onclick="inputCheck()" class="jbtn_2" value="회원 정보 조회">
                </form>    
            </div>
