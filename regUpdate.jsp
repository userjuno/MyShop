...
<li style="padding: 15%;"><a style="color: white;width:80px" href="freeboardList.fbo">질문게시판</a></li>
    ...
    <div class="contents" style="padding-top: 70px;">
            ...
            <h1 class="M_header">회원정보 수정</h1>
            <div class="up_form">
                <form name="upFrm" method="post" action="memberUp.jsp" >
                    		
                    <input name ="pwd" style="margin: 2.5% 0;" type="password" id="M_t" class="Mo_pw1" placeholder="비밀번호">
                    <input name ="repwd" style="margin: 2.5% 0;" type="password" id="M_t" class="Mo_cpw1" placeholder="비밀번호 확인">
                     <input name="phone" style="margin: 2.5% 0;" type="text" id="M_t" class="Mo_phone1" placeholder="전화번호 - 빼고 입력해주세요">
                     <input type="button" margin: 2.5% 0;" class="M_b same"   value="전화번호중복확인" onClick="phoneCheck(this.form.phone.value)">
                    <input name="name" style="margin: 2.5% 0;" type="text" id="M_t" class="Mo_name1" placeholder="이름">
                    
                    <input name="zipcode" style="margin: 2.5% 0;" class="M_t zipcode1"  type="text" id="sample6_postcode_1" placeholder="우편번호">
                    <input style="margin: 2.5% 0;" class="M_b find_zip_1"  type="button" onclick="sample6_execDaumPostcode_1()" value="우편번호 찾기"><br>
                    <input name="address" style="margin: 2.5% 0;" class="M_t"  type="text" id="sample6_address_1" placeholder="주소"><br>
                    <input name="addr_more" style="margin: 2.5% 0;" class="M_t"  type="text" id="sample6_detailAddress_1" placeholder="상세주소">
                    <input style="margin: 2.5% 0;" class="M_t"  type="text" id="sample6_extraAddress_1" placeholder="참고항목">
                    <input type="button" id="M_t" style="text-align: center;" onclick="inputCheck()" class="jbtn_1" value="회원 정보 변경">
                </form>    
            </div>
