...
<style type="text/css">
    ...
    .count_box p{
        ...
        padding: 2%;
        margin-left: 5%;
        border-bottom: 1px rgb(141, 139, 139) dashed;
    }
    .option_btn{
        float: left;
        color: #212121;
        ...
        margin-top: 3%;
        margin-left: 5%;
        border: 1px rgba(173, 168, 168,0.4) solid;
    }
    .minus{
        width: 25%;
        font-size: 2.5em;
        ...
        height: 100%;
        float: left;
        border-right: 1px rgba(173, 168, 168,0.4) solid;
    }
    .count_num{
        width: 45%;
        float: left;
    ...
    .plus{
        ...
        height: 100%;
        float: left;
        border-left: 1px rgba(173, 168, 168,0.4) solid;
    }
    .count_box span{
        float: left;
        padding-top: 3%;
    ...
    .buy{
     ...
     .more{
        ...
        font-family: 'Jua', sans-serif;
        border-bottom: 1px solid rgba(173, 168, 168,0.4);
        padding-bottom: 1%;
     }
     .moreinfo{
         width: 85%;
...
<li style="padding: 15%;"><a style="color: white;width:80px" href="freeboardList.fbo">질문게시판</a></li>
   ...
   <ul class="move_page">
            <li><a href="boardList.bo">Main</a>></li>
            <li><a href="dogList.dog">Shop</a>></li>
            <li><a href="#"><strong>HERE</strong></a></li>
            </ul>
            ...
            <h2>${dog.item_name}의 상세정보</h2>
                <div class="imgbox">
              	 ...
              	 <div class="Info">
				            <h3>상표 : </h3> ${dog.item_name}<br>
							<h3>가격 : </h3> ${dog.price}<br>
							<h3>원산지 : </h3> ${dog.made}<br>
							<h3>카테고리 : </h3> ${dog.category}<br>
							<h3>배송비 : </h3> ${dog.trans_pay} 원<br>
		                  
		                    <%
								String b = (String)session.getAttribute("id");
								System.out.println("세션 아이디" + b);
								%>
		                    <p style="padding: 3%;padding-left: 0; font-size: 1.3em;">총 금액<span style="padding-left: 13%;"> ${dog.price+dog.trans_pay}</span></p>
		                    <div class="buybtn">
		                       <a href="dogPayForm.dog?id=${dog.id}"  class="buy" style="color: white;">구매하기</a>
            ...
            <div style="margin-left:11%">
            	<ul class="more" style="width: 83%; text-align: center;">
                <li style="width: 15%; padding-left: 0%;"><a href="#moreinfo">상세정보</a></li>
                <!-- <li style="width: 15%;"><a href="#buyafter"style="width: 40%;">구매평</a></li>
                <li style="width: 15%; padding-right: 3%;"><a href="#QNA">Q & A</a></li> -->
            </ul>
            <div class="moreinfo" >
                <p id="moreinfo"><b>내용 : </b> ${dog.content}<br>.</p>
            </div>
           <%--  <div   >
                <h3 id="buyafter">구매평</h3>
                <a style="padding:0.7% 2.1%;" class="write buyafter modal-open" href="javascript:openModal('modal7');">구매평 작성</a>
                 <div id="comment">
    ...
    <c:if test="${requestScope.commentList != null}">
        <c:forEach var="comment" items="${requestScope.commentList}">
            ...
            <div class="QNA">
                <h3  id="QNA">Q&A</h3>
                <button class="write"><a href="client sangdam.jsp">상품문의</a></button>
