...
<!--                 
            ...
            <div id="tab" class="pabs" style="margin-left: 16%; margin-bottom: -7%;">
                ...
                <a href="clien_FQA_2.jsp"style="background-color:#F04130;" >주문/배송</a>    
            ...
            <h2><img style="margin-left:38%;" src="https://www.sidiz.com/img/tl2/tl2_faq_A01002.jpg" alt=""></h2>
            
            <table id="faqtbl">
                <tbody><tr id="qst_9" class="qst">
                    <td class="question1" onclick="show('9')">
                        <span style="margin:0 10px; color:#fff;">▶</span>주문 취소는 어떻게 하나요?</td>
                </tr>
                <tr id="ans1_9" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('9')">
                        <span style="margin:0 10px; color:red;">▼</span>주문 취소는 어떻게 하나요?</td>
                </tr>
                <tr id="ans2_9" style="display:none;" class="ans2">		
                    <td style="padding:10px 35px;">
                    <p><span style="font-size: 9pt;">주문을 완료한 뒤 주문 취소를 원할 시 고객센터에 문의 부탁드립니다.</span></p><p><br></p><p ><span style="font-size: 9pt;">쇼핑몰 내에 있는 [고객센터&gt; 친절상담]에 문의사항을 남겨주시거나</span></p><p ><span style="font-size: 9pt;">시디즈 고객센터(1899-3176)</span><span style="font-size: 9pt;">로 연락 주시면 신속하게 수정해드리겠습니다.</span><span style="font-size: 9pt;"><span >주문을 취소하시고자 할 경우, 한 개의 주문번호에 속한 상품 전체가 취소되므로  </span><br><span style="font-size: 9pt;">일부 품목의 주문 취소 혹은 주문 수량의 변경 등을 원하실 때에는 해당 주문을 취소하시고  </span><br><span style="font-size: 9pt;">새로 주문하셔야 합니다.</span><br></p></td>
                </tr>
                <tr><td class="h5"></td></tr>	
                <tr id="qst_43" class="qst">
                    <td class="question1" onclick="show('43')">
                        <span style="margin:0 10px; color:#fff;">▶</span>배송지 변경은 어떻게 하나요?</td>
                </tr>
                <tr id="ans1_43" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('43')">
                        <span style="margin:0 10px; color:red;">▼</span>배송지 변경은 어떻게 하나요?</td>
                </tr>
                ...
                <tr id="qst_10" class="qst">
                    <td class="question1" onclick="show('10')">
                        <span style="margin:0 10px; color:#fff;">▶</span>배송일자를 변경하려면 어떻게 해야 하나요?</td>
                </tr>
                <tr id="ans1_10" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('10')">
                        <span style="margin:0 10px; color:red;">▼</span>배송일자를 변경하려면 어떻게 해야 하나요?</td>
                </tr>
                ...
                <tr id="qst_11" class="qst">
                    <td class="question1" onclick="show('11')">
                        <span style="margin:0 10px; color:#fff;">▶</span>배송은 어느 정도 시일이 걸리나요?</td>
                </tr>
                <tr id="ans1_11" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('11')">
                        <span style="margin:0 10px; color:red;">▼</span>배송은 어느 정도 시일이 걸리나요?</td>
                </tr>
                ...
                <tr id="qst_12" class="qst">
                    <td class="question1" onclick="show('12')">
                        <span style="margin:0 10px; color:#fff;">▶</span>배송은 어떻게 진행되나요?</td>
                </tr>
                <tr id="ans1_12" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('12')">
                        <span style="margin:0 10px; color:red;">▼</span>배송은 어떻게 진행되나요?</td>
                </tr>
                ...
                <tr id="qst_13" class="qst">
                    <td class="question1" onclick="show('13')">
                        <span style="margin:0 10px; color:#fff;">▶</span>시디즈 제품은 꼭 대리점을 방문해서만 구입할 수 있나요?</td>
                </tr>
                <tr id="ans1_13" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('13')">
                        <span style="margin:0 10px; color:red;">▼</span>시디즈 제품은 꼭 대리점을 방문해서만 구입할 수 있나요?</td>
                </tr>
                ...
                <tr id="qst_14" class="qst">
                    <td class="question1" onclick="show('14')">
                        <span style="margin:0 10px; color:#fff;">▶</span>따로 배송설치비가 청구되나요?</td>
                </tr>
                <tr id="ans1_14" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('14')">
                        <span style="margin:0 10px; color:red;">▼</span>따로 배송설치비가 청구되나요?</td>
                </tr>
                ...
                <tr id="qst_15" class="qst">
                    <td class="question1" onclick="show('15')">
                        <span style="margin:0 10px; color:#fff;">▶</span>배송 및 설치는 누가 어느 지역까지 어떻게 하나요?</td>
                </tr>
                <tr id="ans1_15" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('15')">
                        <span style="margin:0 10px; color:red;">▼</span>배송 및 설치는 누가 어느 지역까지 어떻게 하나요?</td>
                </tr>
