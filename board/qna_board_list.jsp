...
#tr_top > td:first-child{
	border-top-left-radius: 40%;
	
}
#tr_top > td:last-child{
...
.slideshow-indicator a:nth-child(2n-1){
    background-color: #fff;
}
.slideshow-indicator a:nth-child(2n){
    ...
    <div class="contents" style="margin-top: 5%;">
     <div class="slideshow">
            <div class="slideshow-slides">
                <a href="#" class="slide" id="slide-1"><img src="images/Food_Chees.jpg" alt="" width="1600" height="465"></a>
                <a href="#" class="slide" id="slide-2"><img src="images/Food_HotHoney.jpg" alt="" width="1600" height="465"></a>
                <a href="#" class="slide" id="slide-3"><img src="images/kn_Toolkit.jpg" alt="" width="1600" height="465"></a>
                <a href="#" class="slide" id="slide-4"><img src="images/pl_CheeseCoaster.jpg" alt="" width="1600" height="465"></a>
...
<div style="position:relative;margin-left:70%;">
	<h2 class="my_power">
			<a style="background-color:rgb(233,233,233);width:100px;height:20px;padding:13px" href="boardWriteForm.bo">게시판글쓰기</a>
		</h2>
      ...
      <%}%>
  		...
  		$(document).ready(function(){
  		 ...
  		 $('.slideshow').each(function(){
  	        var $con = $(this),
  	            $slideGroup = $con.find('.slideshow-slides'),
  	            $slide = $slideGroup.find('.slide'),
  	            $nav = $con.find('.slideshow-nav'),
  	            $indicator = $con.find('.slideshow-indicator'),
  	        ...
  	        $('#1').html('Cheese BOX 25% 할인');
  	        $('#2').html('Hot HONEY 50% 할인');
  	        $('#3').html('Tool BOX 신규 상품');
  	        $('#4').html('치즈맛 불판 10% 할인!');
  	        ...
  	        function gotoslide(i){
  	            ...
  	            if(currentIndex==slideCount-1){
  	                $slideGroup.stop(true).animate({left:-100 * (0) + '%'},duration,easing);
  	                currentIndex=0;
  	                update();
  	            }
  	            else if(currentIndex<slideCount-1){
  	                $slideGroup.stop(true).animate({left:-100 * (i+1) + '%'},duration,easing);
  	                currentIndex++;
  	        ...
  	        $('.slideshow-indicator a').on('click',function(){
  	            currentIndex = $(this).attr('id')-1;
  	            $slideGroup.stop(true).animate({left:-100 * (currentIndex) + '%'},duration,easing);
  	            $indicator.find('a').removeClass('active').eq(currentIndex).addClass('active');
  	        ...
  	        starttimer();
  	        function backtoslide(i){  
  	            currentIndex = i;
  	            if(currentIndex==0){
  	                
  	                currentIndex=slideCount-1;
  	                $slideGroup.stop(true).animate({left:-100 * parseInt($slide.length-1) + '%'},duration,easing);
  	                update();
  	            }
  	            else{
  	                currentIndex--;
