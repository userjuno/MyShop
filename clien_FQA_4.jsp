    ...
    <div class="contents" style="padding-top: 70px;">
        <div class="menu_nav">
            <P class="nav_p" style="height: 53px;"><strong>고객센터</strong>
                 <a class="faq" href="clien_FQA.jsp">FQA</a>
                
                <a class="find" href="client_map.jsp">매장찾기</a>            </P>
        </div>
        <div id="contents">
            ...
            <div id="tab" class="pabs" style="margin-left: 16%; margin-bottom: -7%;">
                ...
                <a href="clien_FQA_4.jsp" style="background-color:#F04130;">결제</a>
            ...
            <h2><img style="margin-left:38%;" src="https://www.sidiz.com/img/tl2/tl2_faq_A01004.jpg" alt=""></h2>
            <table id="faqtbl">
                <tbody><tr id="qst_19" class="qst">
                    <td class="question1" onclick="show('19')">
                        <span style="margin:0 10px; color:#fff;">▶</span>결제하기 버튼을 눌러도 다음 페이지로 넘어가지 않아요.</td>
                </tr>
                <tr id="ans1_19" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('19')">
                        <span style="margin:0 10px; color:red;">▼</span>결제하기 버튼을 눌러도 다음 페이지로 넘어가지 않아요.</td>
                </tr>
                ...
                <tr id="qst_20" class="qst">
                    <td class="question1" onclick="show('20')">
                        <span style="margin:0 10px; color:#fff;">▶</span>세금계산서는 발행되나요?</td>
                </tr>
                <tr id="ans1_20" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('20')">
                        <span style="margin:0 10px; color:red;">▼</span>세금계산서는 발행되나요?</td>
                </tr>
                ...
                <tr id="qst_21" class="qst">
                    <td class="question1" onclick="show('21')">
                        <span style="margin:0 10px; color:#fff;">▶</span>무통장 입금할 때 시디즈의 계좌번호는? </td>
                </tr>
                <tr id="ans1_21" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('21')">
                        <span style="margin:0 10px; color:red;">▼</span>무통장 입금할 때 시디즈의 계좌번호는? </td>
                </tr>
                ...
                <tr id="qst_23" class="qst">
                    <td class="question1" onclick="show('23')">
                        <span style="margin:0 10px; color:#fff;">▶</span>결제수단은 어떤 것이 있나요?</td>
                </tr>
                <tr id="ans1_23" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('23')">
                        <span style="margin:0 10px; color:red;">▼</span>결제수단은 어떤 것이 있나요?</td>
                </tr>
                ...
                <tr id="qst_24" class="qst">
                    <td class="question1" onclick="show('24')">
                        <span style="margin:0 10px; color:#fff;">▶</span>표시된 가격에 부가가치세(VAT)가 포함된 건가요?</td>
                </tr>
                <tr id="ans1_24" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('24')">
                        <span style="margin:0 10px; color:red;">▼</span>표시된 가격에 부가가치세(VAT)가 포함된 건가요?</td>
                </tr>
                ...
                <tr id="qst_25" class="qst">
                    <td class="question1" onclick="show('25')">
                        <span style="margin:0 10px; color:#fff;">▶</span>환불은 어떻게 하나요?</td>
                </tr>
                <tr id="ans1_25" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('25')">
                        <span style="margin:0 10px; color:red;">▼</span>환불은 어떻게 하나요?</td>
                </tr>
