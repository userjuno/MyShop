...
<!--                 
            ...
            <div id="tab" class="pabs" style="margin-left: 16%; margin-bottom: -7%;">
                ...
                <a href="clien_FQA.jsp" style="background-color:#F04130;" >전체</a>
                <a href="clien_FQA_1.jsp" >제품문의</a>
            ...
            <h2><img style="margin-left:38%;" src="https://www.sidiz.com/img/tl2/tl2_faq_ALL.jpg" alt=""></h2>
            
            <table id="faqtbl">
            <tbody><tr id="qst_2" class="qst">
                <td class="question1" onclick="show('2')">
                    <span style="margin:0 10px; color:#fff;">▶</span>의자 등,좌판이 더러워졌어요. 어떻게 세탁해야 하나요?<span style="float:right;margin:0 10px;">[ 제품문의 ]</span></td>
            </tr>
            <tr id="ans1_2" style="display: none;" class="ans1">	
                <td class="question2" onclick="show('2')">
                    <span style="margin:0 10px; color:red;">▼</span>의자 등,좌판이 더러워졌어요. 어떻게 세탁해야 하나요?<span style="float:right;margin:0 10px;color:#000;">[ 제품문의 ]</span></td>
            </tr>
            <tr id="ans2_2" style="display: none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>시디즈 의자는 대부분 오염방지 가공이된 천 소재로 되어&nbsp;쉽게 오염이 되지 않지만,</p><p>실수로 인하여 오염이 되었을 경우에는 가급적 전문 세탁업체에 의뢰하시는 것이 좋습니다.</p><p>&nbsp;</p><p>T80, T55, T50, T30과&nbsp;같이 의자 좌판이 탈부착 되는 제품의 경우,</p><p>커버를 벗겨 낸 후&nbsp;<span style="font-size: 10pt;">부득이한 경우에만&nbsp;</span><span style="font-size: 10pt;">세탁하시고,</span></p><p><span style="font-size: 10pt;">A/S를 통해 등, 좌판을 교체하시는 것이 바람직합니다.</span></p><p>&nbsp;</p><p>일부 품목(링고 커버, 2단 발받침대&nbsp; 패딩커버)의 경우 40℃의 물에서 세탁 가능합니다.&nbsp;</p><p><br></p><p><span style="font-size: 10pt;"><br></span></p><p><span style="font-size: 10pt;">※ T50과 링고의 교체좌판은 시디즈 쇼핑몰의 액세서리 카테고리에서 구매하실 수 있습니다.</span><br></p><p><span style="font-size: 10pt; color: rgb(140, 140, 140);">※
        T60</span><span style="font-size: 10pt; color: rgb(140, 140, 140);">패브릭</span><span style="font-size: 10pt; color: rgb(140, 140, 140); "> 제품은 소재 특성상 전문 업체를 통한 세탁이 어렵습니다</span><span style="font-size: 10pt; color: rgb(140, 140, 140); ">.</span><br></p><p>&nbsp;</p><p style="text-align: left; margin-top: 0pt; margin-bottom: 0pt;">&nbsp;</p><p>&nbsp;</p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_41" class="qst">
                <td class="question1" onclick="show('41')">
                    <span style="margin:0 10px; color:#fff;">▶</span>좌판교체가 가능한 제품에는 어떤것들이 있나요?<span style="float:right;margin:0 10px;">[ 제품문의 ]</span></td>
            </tr>
            <tr id="ans1_41" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('41')">
                    <span style="margin:0 10px; color:red;">▼</span>좌판교체가 가능한 제품에는 어떤것들이 있나요?<span style="float:right;margin:0 10px;color:#000;">[ 제품문의 ]</span></td>
            </tr>
            ...
            <tr id="qst_42" class="qst">
                <td class="question1" onclick="show('42')">
                    <span style="margin:0 10px; color:#fff;">▶</span>천연가죽에 결함이 있는 것 같아요.<span style="float:right;margin:0 10px;">[ 제품문의 ]</span></td>
            </tr>
            <tr id="ans1_42" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('42')">
                    <span style="margin:0 10px; color:red;">▼</span>천연가죽에 결함이 있는 것 같아요.<span style="float:right;margin:0 10px;color:#000;">[ 제품문의 ]</span></td>
            </tr>
            ...
            <tr id="qst_1" class="qst">
                <td class="question1" onclick="show('1')">
                    <span style="margin:0 10px; color:#fff;">▶</span>바퀴 달린 의자를 사용하고 있는데 의자를 고정 시킬 수는 없나요?<span style="float:right;margin:0 10px;">[ 제품문의 ]</span></td>
            </tr>
            <tr id="ans1_1" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('1')">
                    <span style="margin:0 10px; color:red;">▼</span>바퀴 달린 의자를 사용하고 있는데 의자를 고정 시킬 수는 없나요?<span style="float:right;margin:0 10px;color:#000;">[ 제품문의 ]</span></td>
            </tr>
        ...
        <p>※ 단, 체중이 25KG 이하일 때는 브레이크가 작동되지 않습니다.</p></td>
            ...
            <tr id="qst_3" class="qst">
                <td class="question1" onclick="show('3')">
                    <span style="margin:0 10px; color:#fff;">▶</span>제품 사용기한은 얼마나 되나요?<span style="float:right;margin:0 10px;">[ 제품문의 ]</span></td>
            </tr>
            <tr id="ans1_3" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('3')">
                    <span style="margin:0 10px; color:red;">▼</span>제품 사용기한은 얼마나 되나요?<span style="float:right;margin:0 10px;color:#000;">[ 제품문의 ]</span></td>
            </tr>
            ...
            <tr id="qst_4" class="qst">
                <td class="question1" onclick="show('4')">
                    <span style="margin:0 10px; color:#fff;">▶</span>제품관련 문의는 어디로 하면 될까요?<span style="float:right;margin:0 10px;">[ 제품문의 ]</span></td>
            </tr>
            <tr id="ans1_4" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('4')">
                    <span style="margin:0 10px; color:red;">▼</span>제품관련 문의는 어디로 하면 될까요?<span style="float:right;margin:0 10px;color:#000;">[ 제품문의 ]</span></td>
            </tr>
            ...
            <tr id="qst_5" class="qst">
                <td class="question1" onclick="show('5')">
                    <span style="margin:0 10px; color:#fff;">▶</span>시디즈 제품에는 어떤 조절기능이 있나요?<span style="float:right;margin:0 10px;">[ 제품문의 ]</span></td>
            </tr>
            <tr id="ans1_5" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('5')">
                    <span style="margin:0 10px; color:red;">▼</span>시디즈 제품에는 어떤 조절기능이 있나요?<span style="float:right;margin:0 10px;color:#000;">[ 제품문의 ]</span></td>
            </tr>
            ...
            <tr id="qst_6" class="qst">
                <td class="question1" onclick="show('6')">
                    <span style="margin:0 10px; color:#fff;">▶</span>어떤 의자가 좋은 의자인가요?<span style="float:right;margin:0 10px;">[ 제품문의 ]</span></td>
            </tr>
            <tr id="ans1_6" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('6')">
                    <span style="margin:0 10px; color:red;">▼</span>어떤 의자가 좋은 의자인가요?<span style="float:right;margin:0 10px;color:#000;">[ 제품문의 ]</span></td>
            </tr>
            ...
            <tr id="qst_7" class="qst">
                <td class="question1" onclick="show('7')">
                    <span style="margin:0 10px; color:#fff;">▶</span>어떤 자세로 앉아야 허리에 좋은 자세인가요?<span style="float:right;margin:0 10px;">[ 제품문의 ]</span></td>
            </tr>
            <tr id="ans1_7" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('7')">
                    <span style="margin:0 10px; color:red;">▼</span>어떤 자세로 앉아야 허리에 좋은 자세인가요?<span style="float:right;margin:0 10px;color:#000;">[ 제품문의 ]</span></td>
            </tr>
            ...
            <tr id="qst_8" class="qst">
                <td class="question1" onclick="show('8')">
                    <span style="margin:0 10px; color:#fff;">▶</span>틸팅이 뭔가요?<span style="float:right;margin:0 10px;">[ 제품문의 ]</span></td>
            </tr>
            <tr id="ans1_8" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('8')">
                    <span style="margin:0 10px; color:red;">▼</span>틸팅이 뭔가요?<span style="float:right;margin:0 10px;color:#000;">[ 제품문의 ]</span></td>
            </tr>
            ...
            <tr><td class="h5"></td></tr>	
            <tr id="qst_9" class="qst">
                <td class="question1" onclick="show('9')">
                    <span style="margin:0 10px; color:#fff;">▶</span>주문 취소는 어떻게 하나요?<span style="float:right;margin:0 10px;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans1_9" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('9')">
                    <span style="margin:0 10px; color:red;">▼</span>주문 취소는 어떻게 하나요?<span style="float:right;margin:0 10px;color:#000;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans2_9" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p><span style="font-size: 9pt;">주문을 완료한 뒤 주문 취소를 원할 시 고객센터에 문의 부탁드립니다.</span></p><p><br></p><p ><span style="font-size: 9pt;">쇼핑몰 내에 있는 [고객센터&gt; 친절상담]에 문의사항을 남겨주시거나</span></p><p><span style="font-size: 9pt;">시디즈 고객센터(1899-3176)</span><span style="font-size: 9pt;">로 연락 주시면 신속하게 수정해드리겠습니다.</span><span ><span ><br></span></p><p><span style="font-size: 9pt;">주문을 취소하시고자 할 경우, 한 개의 주문번호에 속한 상품 전체가 취소되므로  </span><br><span style="font-size: 9pt;">일부 품목의 주문 취소 혹은 주문 수량의 변경 등을 원하실 때에는 해당 주문을 취소하시고  </span><br><span style="font-size: 9pt;">새로 주문하셔야 합니다.</span><br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_43" class="qst">
                <td class="question1" onclick="show('43')">
                    <span style="margin:0 10px; color:#fff;">▶</span>배송지 변경은 어떻게 하나요?<span style="float:right;margin:0 10px;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans1_43" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('43')">
                    <span style="margin:0 10px; color:red;">▼</span>배송지 변경은 어떻게 하나요?<span style="float:right;margin:0 10px;color:#000;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans2_43" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p><span style="font-size: 9pt;">주문이 완료된 뒤</span><span style="font-size: 9pt;">&nbsp;배송지 정보 변경은 고객센터를 통해 가능합니다.</span></p><p><span style="font-size: 9pt;"><br></span></p><p><span style="font-size: 9pt;">쇼핑몰 내에 있는 [고객센터&gt; 친절상담] 에 문의사항을 남겨주시거나</span></p><p><span style="font-size: 9pt;">시디즈 고객센터(1899-3176)</span><span style="font-size: 9pt;">로 연락 주시면 신속하게 수정해드리겠습니다.</span></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_10" class="qst">
                <td class="question1" onclick="show('10')">
                    <span style="margin:0 10px; color:#fff;">▶</span>배송일자를 변경하려면 어떻게 해야 하나요?<span style="float:right;margin:0 10px;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans1_10" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('10')">
                    <span style="margin:0 10px; color:red;">▼</span>배송일자를 변경하려면 어떻게 해야 하나요?<span style="float:right;margin:0 10px;color:#000;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans2_10" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>시디즈 고객센터(1899-3176)로 연락 주시면, 배송단계를 확인하고 원하시는 날짜로 변경이 가능합니다.  <br><br>또한 시디즈는 주문 건이 확인된 후, 해당권역 별로 주문을 할당하고 배송을 하게 됩니다.  <br><br>따라서 총판이 직접 고객님께 연락을 드리게 되는데 그때 고객님이 해당 총판에 변경하시고자 하는  <br>배송일자를 말씀하셔도 조정이 가능합니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_11" class="qst">
                <td class="question1" onclick="show('11')">
                    <span style="margin:0 10px; color:#fff;">▶</span>배송은 어느 정도 시일이 걸리나요?<span style="float:right;margin:0 10px;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans1_11" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('11')">
                    <span style="margin:0 10px; color:red;">▼</span>배송은 어느 정도 시일이 걸리나요?<span style="float:right;margin:0 10px;color:#000;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans2_11" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>시디즈는 주문하신 날부터 7일 이내에 제품을 받으실 수 있도록 최선을 다하고 있습니다.  <br><br>단, 성수기나 부득이한 사유로 납기가 지연될 수 있으니 주문시 '배송 요청사항'에  <br>배송과 관련된 특이사항을 적어주시거나 사전협의를 해주시기 바랍니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_12" class="qst">
                <td class="question1" onclick="show('12')">
                    <span style="margin:0 10px; color:#fff;">▶</span>배송은 어떻게 진행되나요?<span style="float:right;margin:0 10px;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans1_12" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('12')">
                    <span style="margin:0 10px; color:red;">▼</span>배송은 어떻게 진행되나요?<span style="float:right;margin:0 10px;color:#000;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans2_12" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>시디즈에서는 고객님이 결제하신 내역을 접수받아 해당지역 관할 총판에 주문 건을 할당합니다.  <br><br>주문 건을 할당받은 총판은 주문하신 내역이 맞는지, 배송을 희망하는 날짜 혹은 시간이 있는지  <br>확인전화를 드리고 협의한 일정에 맞추어 배송을 진행하고 있습니다. <br><br>단, 주문의 폭주, 천재지변, 배송 과정에 차질이 발생한 경우 등에는 배송이 지연될 수 있음을  <br>양지해 주시기 바랍니다. <br><br>이러한 경우, 고객님께 사전에 메일이나 전화로 배송 지연 사실을 알려 드리며,  <br>상담을 통해 배송 요청일을 다시 조정하실 수 있습니다.  <br><br>일부 상품은 택배로 배송될 수 있으며, 도서/산간지역은 배송이 다소 늦을 수 있습니다. <br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_13" class="qst">
                <td class="question1" onclick="show('13')">
                    <span style="margin:0 10px; color:#fff;">▶</span>시디즈 제품은 꼭 대리점을 방문해서만 구입할 수 있나요?<span style="float:right;margin:0 10px;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans1_13" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('13')">
                    <span style="margin:0 10px; color:red;">▼</span>시디즈 제품은 꼭 대리점을 방문해서만 구입할 수 있나요?<span style="float:right;margin:0 10px;color:#000;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans2_13" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>홈페이지 및 온라인쇼핑몰을 통해서도 구입이 가능합니다. <br><br>또한 카달로그나 홈페이지에서 제품을 보시고, 홈페이지에 안내되어 있는 대리점에 직접 연락하셔서 <br>전화상으로 주문하는 방법도 있습니다.  <br><br>하지만, 시디즈 제품은 일단 조립이 된 후에는 재판매가 사실상 어렵기 때문에 <br>고객님의 마음에 들지 않아도 반품이 어렵습니다. <br><br>따라서, 구매 전 대리점을 방문하셔서 직접 체험해 보실 것을 권해 드립니다. <br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_14" class="qst">
                <td class="question1" onclick="show('14')">
                    <span style="margin:0 10px; color:#fff;">▶</span>따로 배송설치비가 청구되나요?<span style="float:right;margin:0 10px;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans1_14" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('14')">
                    <span style="margin:0 10px; color:red;">▼</span>따로 배송설치비가 청구되나요?<span style="float:right;margin:0 10px;color:#000;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans2_14" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>그렇지 않습니다. <br>현재 시디즈 제품에 표시된 모든 가격은 일체의 배송설치비가 포함된 것입니다.  <br><br>단, 도서/산간 지역은 추가로 배송설치비가 청구될 수 있으니 이 부분은 양해 바랍니다. <br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_15" class="qst">
                <td class="question1" onclick="show('15')">
                    <span style="margin:0 10px; color:#fff;">▶</span>배송 및 설치는 누가 어느 지역까지 어떻게 하나요?<span style="float:right;margin:0 10px;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans1_15" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('15')">
                    <span style="margin:0 10px; color:red;">▼</span>배송 및 설치는 누가 어느 지역까지 어떻게 하나요?<span style="float:right;margin:0 10px;color:#000;">[ 주문/배송/시공 ]</span></td>
            </tr>
            <tr id="ans2_15" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>시디즈는 각 권역별로 총판을 운영하여 보다 신속한 배송을 위해 노력하고 있습니다. <br><br>배송지역은 전국 주요도시와 광역권이며 일부 도서 및 산간지역은 배송이 안되거나 다소 늦을 수 있습니다. <br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_16" class="qst">
                <td class="question1" onclick="show('16')">
                    <span style="margin:0 10px; color:#fff;">▶</span>상품을 받았는데 상품이 불량입니다. 교환해주세요.<span style="float:right;margin:0 10px;">[ 교환/반품 ]</span></td>
            </tr>
            <tr id="ans1_16" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('16')">
                    <span style="margin:0 10px; color:red;">▼</span>상품을 받았는데 상품이 불량입니다. 교환해주세요.<span style="float:right;margin:0 10px;color:#000;">[ 교환/반품 ]</span></td>
            </tr>
            <tr id="ans2_16" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>배송 받으신 제품이 불량인 경우, 기획재정부 '소비자피해보상규정'에 따라 제품을 수리 또는 교환해 <br>드리고 있습니다.  <br><br>시공할 때 불량부분을 발견하셨다면 배송을 담당한 총판에 말씀해 주시고, 사용하시다가 발견하셨다면 <br>홈페이지를 통해 접수 또는 고객센터(1577-5674)로 전화 주십시오.  <br><br>단, 사용 중에 발생된 하자에 대해서는 유상처리로 진행하고 있습니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_17" class="qst">
                <td class="question1" onclick="show('17')">
                    <span style="margin:0 10px; color:#fff;">▶</span>시디즈 의자는 반품이 안되나요?<span style="float:right;margin:0 10px;">[ 교환/반품 ]</span></td>
            </tr>
            <tr id="ans1_17" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('17')">
                    <span style="margin:0 10px; color:red;">▼</span>시디즈 의자는 반품이 안되나요?<span style="float:right;margin:0 10px;color:#000;">[ 교환/반품 ]</span></td>
            </tr>
            <tr id="ans2_17" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>배송 전 이나 조립 전에 취소를 요청하시면 최대한 반품을 수용하고 있습니다.  <br><br>단, 제품불량의 경우 외에 조립된 제품은 반품이 불가능합니다.  <br><br>한 번이라도 조립이 되어졌던 제품은 재조립이 일부 불가능하며, 재판매가 불가능하기 때문에  <br>반품을 해 드리지 않고 있습니다.  <br><br>이 점 양지해 주시길 바랍니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_18" class="qst">
                <td class="question1" onclick="show('18')">
                    <span style="margin:0 10px; color:#fff;">▶</span>교환/ 반품은 어떻게 진행되나요?<span style="float:right;margin:0 10px;">[ 교환/반품 ]</span></td>
            </tr>
            <tr id="ans1_18" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('18')">
                    <span style="margin:0 10px; color:red;">▼</span>교환/ 반품은 어떻게 진행되나요?<span style="float:right;margin:0 10px;color:#000;">[ 교환/반품 ]</span></td>
            </tr>
            <tr id="ans2_18" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>시디즈 온라인 쇼핑몰에서 구매하신 제품에 대한 교환/반품의 접수는 배송시 지정된 대리점에서 처리해 <br>드리고 있으며, 고객센터(<span>1899-3176</span>)로 연락주시면 교환/반품에 대한 내용을 협의하실 수 있습니다. <br><br>공정거래위원회가 인증한 표준약관에 의거, 상품 인도 후 7일 이내에 다음의 사유에 의한 교환, 반품 및 <br>환불을 보장하고 있습니다.  <br><br>고객의 단순한 변심으로 교환, 반품 및 환불을 요구할 때 수반되는 배송비는 고객님께서 부담하셔야 합니다.  <br>또한, 상품을 개봉했거나 설치한 후에는 상품의 재판매가 불가능하므로 고객님의 변심에 의한 교환, 반품이 <br>불가능함을 양지해 주시기 바랍니다. <br><br>☞ 교환 및 반품이 가능한 경우 <br>□ 배송된 상품이 주문 내용과 상이하거나 시디즈에서 제공한 정보와 상이할 경우  <br>□ 배송된 상품 자체에 이상 및 결함이 있을 경우 <br>□ 배송된 상품이 파손, 손상되었거나 오염되었을 경우 <br><br>☞ 교환 및 반품이 불가능한 경우 <br>□ 고객님의 책임 있는 사유로 상품 등이 멸실 또는 훼손된 경우 <br>□ 고객님의 사용 또는 일부 소비에 의하여 상품의 가치가 현저히 감소한 경우 <br>□ 재판매가 곤란할 정도로 상품 등의 가치가 현저히 감소한 경우 <br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_19" class="qst">
                <td class="question1" onclick="show('19')">
                    <span style="margin:0 10px; color:#fff;">▶</span>결제하기 버튼을 눌러도 다음 페이지로 넘어가지 않아요.<span style="float:right;margin:0 10px;">[ 결제 ]</span></td>
            </tr>
            <tr id="ans1_19" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('19')">
                    <span style="margin:0 10px; color:red;">▼</span>결제하기 버튼을 눌러도 다음 페이지로 넘어가지 않아요.<span style="float:right;margin:0 10px;color:#000;">[ 결제 ]</span></td>
            </tr>
            <tr id="ans2_19" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>시디즈 온라인 쇼핑몰에서 의자를 고르신 후, 결제를 하실 때 팝업이 차단되어 있으면 <br>결제모듈이 뜨지 않습니다. <br><br>인터넷 브라우저 메뉴상에서 [도구]→[팝업 차단]→[팝업 차단 사용안함] 으로 설정하시고 <br>결제를 진행해주세요. <br><br>만약 [팝업 차단]을 해제하지 않으시고 구매를 하실 경우에는 브라우저 상단에 깜박거리면서  <br>팝업이 차단되었다는 메시지가 나오는데, 그 메시지를 클릭해서 팝업을 임시로 허용해 주시면 <br>정상적으로 결제하실 수 있습니다. <br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_20" class="qst">
                <td class="question1" onclick="show('20')">
                    <span style="margin:0 10px; color:#fff;">▶</span>세금계산서는 발행되나요?<span style="float:right;margin:0 10px;">[ 결제 ]</span></td>
            </tr>
            <tr id="ans1_20" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('20')">
                    <span style="margin:0 10px; color:red;">▼</span>세금계산서는 발행되나요?<span style="float:right;margin:0 10px;color:#000;">[ 결제 ]</span></td>
            </tr>
            <tr id="ans2_20" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>[신용카드] <br>부가가치세법 시행령 제57조 제2항에 의해 신용카드 매출전표 등을 교부한 경우에는 <br>세금계산서를 교부하지 않습니다. <br><br>[무통장(가상계좌)] <br>5,000원 이상의 모든 무통장 입금 건은 현금영수증이 자진 발급됩니다.  <br>부가가치세 환급을 원하실 경우, 결제화면에서 현금영수증 지출증빙을 신청하셔서  <br>환급에 활용하시면 됩니다. <br>따라서, 별도로 세금계산서는 발행해 드리지 않습니다.&nbsp; <br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_21" class="qst">
                <td class="question1" onclick="show('21')">
                    <span style="margin:0 10px; color:#fff;">▶</span>무통장 입금할 때 시디즈의 계좌번호는? <span style="float:right;margin:0 10px;">[ 결제 ]</span></td>
            </tr>
            <tr id="ans1_21" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('21')">
                    <span style="margin:0 10px; color:red;">▼</span>무통장 입금할 때 시디즈의 계좌번호는? <span style="float:right;margin:0 10px;color:#000;">[ 결제 ]</span></td>
            </tr>
            <tr id="ans2_21" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>시디즈의 계좌는 일회성 입금계좌번호(가상계좌)이므로 매 주문시 마다 변경됩니다. <br><br>따라서, 주문을 완료하신 후 반드시 은행 및 계좌번호를 별도 메모하시거나 발송된 문자메시지 또는 <br>E-mail을 통해 꼭 확인하시길 바랍니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_23" class="qst">
                <td class="question1" onclick="show('23')">
                    <span style="margin:0 10px; color:#fff;">▶</span>결제수단은 어떤 것이 있나요?<span style="float:right;margin:0 10px;">[ 결제 ]</span></td>
            </tr>
            <tr id="ans1_23" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('23')">
                    <span style="margin:0 10px; color:red;">▼</span>결제수단은 어떤 것이 있나요?<span style="float:right;margin:0 10px;color:#000;">[ 결제 ]</span></td>
            </tr>
            <tr id="ans2_23" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>현재, 두 가지 결제수단(신용카드, 무통장 입금)을 제공하고 있습니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_24" class="qst">
                <td class="question1" onclick="show('24')">
                    <span style="margin:0 10px; color:#fff;">▶</span>표시된 가격에 부가가치세(VAT)가 포함된 건가요?<span style="float:right;margin:0 10px;">[ 결제 ]</span></td>
            </tr>
            <tr id="ans1_24" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('24')">
                    <span style="margin:0 10px; color:red;">▼</span>표시된 가격에 부가가치세(VAT)가 포함된 건가요?<span style="float:right;margin:0 10px;color:#000;">[ 결제 ]</span></td>
            </tr>
            <tr id="ans2_24" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>예, 시디즈의 전 제품에 표시된 가격은 부가가치세 10%가 포함된 가격입니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_25" class="qst">
                <td class="question1" onclick="show('25')">
                    <span style="margin:0 10px; color:#fff;">▶</span>환불은 어떻게 하나요?<span style="float:right;margin:0 10px;">[ 결제 ]</span></td>
            </tr>
            <tr id="ans1_25" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('25')">
                    <span style="margin:0 10px; color:red;">▼</span>환불은 어떻게 하나요?<span style="float:right;margin:0 10px;color:#000;">[ 결제 ]</span></td>
            </tr>
            <tr id="ans2_25" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>소비자 보호규정에 의거하여 주문의 취소일 혹은 재화 등을 반환 받은 날로부터 영업일 3일 이내에  <br>결제 금액을 환불해 드립니다. <br><br>신용카드로 결제하신 경우에는 신용카드 승인을 취소하여 결제 대금이 청구되지 않게 합니다. <br>단, 신용카드 결제일자에 맞추어 대금이 청구될 경우, 익월 신용카드 대금 청구시 카드사에서 <br>환급 처리됩니다.  <br><br>무통장 입금의 경우에는 주문의 취소 혹은 제품 회수 후 입금계좌가 확인되면 3일 이내에 환불해 드립니다. <br>(토요일, 일요일 및 공휴일 제외) <br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_26" class="qst">
                <td class="question1" onclick="show('26')">
                    <span style="margin:0 10px; color:#fff;">▶</span>탈퇴 후 재가입이 가능한가요?<span style="float:right;margin:0 10px;">[ 회원가입/탈퇴 ]</span></td>
            </tr>
            <tr id="ans1_26" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('26')">
                    <span style="margin:0 10px; color:red;">▼</span>탈퇴 후 재가입이 가능한가요?<span style="float:right;margin:0 10px;color:#000;">[ 회원가입/탈퇴 ]</span></td>
            </tr>
            <tr id="ans2_26" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>고객님의 정보 보호를 위해 회원 탈퇴 후, 재가입은 2개월 후에 가능하며 <br>기존 아이디로는 재가입하실 수 없습니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_28" class="qst">
                <td class="question1" onclick="show('28')">
                    <span style="margin:0 10px; color:#fff;">▶</span>회원 탈퇴 후 개인정보는 어떻게 관리되나요?<span style="float:right;margin:0 10px;">[ 회원가입/탈퇴 ]</span></td>
            </tr>
            <tr id="ans1_28" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('28')">
                    <span style="margin:0 10px; color:red;">▼</span>회원 탈퇴 후 개인정보는 어떻게 관리되나요?<span style="float:right;margin:0 10px;color:#000;">[ 회원가입/탈퇴 ]</span></td>
            </tr>
            <tr id="ans2_28" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>회원 탈퇴 시 고객님의 정보는 상품 반품 및 A/S를 위해 아래와 같은 전자상거래 등에서의 <br>소비자보호에 관한 법률에 의거한 시디즈 고객정보 보호정책에 따라 관리됩니다. <br><br>※ 시디즈 고객정보 보호정책: 개인정보의 보유기간 및 이용기간  <br><br>□ 귀하의 개인정보는 다음과 같이 개인정보의 수집목적 또는 제공받은 목적이 달성되면 파기됩니다.  <br>단, 상법 등 관련법령의 규정에 의하여 다음과 같이 거래 관련 권리 의무 관계의 확인 등을 이유로 <br>일정기간 보유하여야 할 필요가 있을 경우에는 일정기간 보유합니다. <br><br>□ 회원가입정보의 경우, 회원가입을 탈퇴하거나 회원에서 제명된 경우 등 사전에 보유목적, 기간 및 <br>보유하는 개인정보 항목을 명시하여 동의를 구합니다. <br><br>□ 계약 또는 청약철회 등에 관한 기록 : 5년 <br><br>□ 대금결제 및 재화 등의 공급에 관한 기록 : 5년 <br><br>□ 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년&nbsp; <br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_29" class="qst">
                <td class="question1" onclick="show('29')">
                    <span style="margin:0 10px; color:#fff;">▶</span>회원 가입할 때 어떤 정보를 입력해야 하나요?<span style="float:right;margin:0 10px;">[ 회원가입/탈퇴 ]</span></td>
            </tr>
            <tr id="ans1_29" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('29')">
                    <span style="margin:0 10px; color:red;">▼</span>회원 가입할 때 어떤 정보를 입력해야 하나요?<span style="float:right;margin:0 10px;color:#000;">[ 회원가입/탈퇴 ]</span></td>
            </tr>
            <tr id="ans2_29" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>시디즈의 회원 가입 절차는 매우 간단합니다. <br>다른 온라인 쇼핑몰에 비해 훨씬 간편하게 회원 가입을 하실 수 있습니다. <br><br>1. 회원가입 버튼 클릭 <br>2. 회원을 식별할 수 있는 이름, 성별, 생년월일, 이메일, 휴대전화번호 입력<br>3. 회원정보 입력 : ID 및 비밀번호 <br>4. 확인 버튼 클릭 <br><br>위와 같은 절차 만으로 회원 가입이 완료됩니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_30" class="qst">
                <td class="question1" onclick="show('30')">
                    <span style="margin:0 10px; color:#fff;">▶</span>회원 탈퇴는 어떻게 하나요?<span style="float:right;margin:0 10px;">[ 회원가입/탈퇴 ]</span></td>
            </tr>
            <tr id="ans1_30" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('30')">
                    <span style="margin:0 10px; color:red;">▼</span>회원 탈퇴는 어떻게 하나요?<span style="float:right;margin:0 10px;color:#000;">[ 회원가입/탈퇴 ]</span></td>
            </tr>
            <tr id="ans2_30" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>마이페이지의 [회원탈퇴] 메뉴를 이용하여 탈퇴를 신청하실 수 있으며,  <br>주문하신 상품이 배송 진행 중이거나 반품처리 등 고객서비스가 완료되지 않은 경우에는 <br>서비스 완료 후에 탈퇴가 가능합니다. <br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_31" class="qst">
                <td class="question1" onclick="show('31')">
                    <span style="margin:0 10px; color:#fff;">▶</span>A/S 접수를 했는데 언제쯤 조치가 되나요?<span style="float:right;margin:0 10px;">[ A/S ]</span></td>
            </tr>
            <tr id="ans1_31" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('31')">
                    <span style="margin:0 10px; color:red;">▼</span>A/S 접수를 했는데 언제쯤 조치가 되나요?<span style="float:right;margin:0 10px;color:#000;">[ A/S ]</span></td>
            </tr>
            <tr id="ans2_31" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>A/S 접수 후 3~5일 이내에 자재 또는 부품을 가지고 A/S 전문기사가 방문해 드리고 있습니다.  <br>단, 자재 수급기간이 오래 걸리는 경우에는 다소 지연될 수 있습니다. <br><br>※ 유상 조치건에 해당될 경우에는 고객센터(1577-5674)를 통해 금액을 안내해 드리고 있습니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_32" class="qst">
                <td class="question1" onclick="show('32')">
                    <span style="margin:0 10px; color:#fff;">▶</span>A/S 는 어떻게 신청하나요?<span style="float:right;margin:0 10px;">[ A/S ]</span></td>
            </tr>
            <tr id="ans1_32" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('32')">
                    <span style="margin:0 10px; color:red;">▼</span>A/S 는 어떻게 신청하나요?<span style="float:right;margin:0 10px;color:#000;">[ A/S ]</span></td>
            </tr>
            <tr id="ans2_32" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>사용도중 하자가 발생할 경우에는 구입 대리점이나 시디즈 고객센터(1577-5674) 또는  <br>홈페이지의 [A/S문의]로 접수하시면 상담원이 구입한 시기, 사용하고 있는 모델 등을 확인하여 <br>신속하게 처리를 해 드립니다. <br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_33" class="qst">
                <td class="question1" onclick="show('33')">
                    <span style="margin:0 10px; color:#fff;">▶</span>시디즈 의자를 사용하다가 실수로 부품이 파손 되었습니다. A/S 가능한가요?<span style="float:right;margin:0 10px;">[ A/S ]</span></td>
            </tr>
            <tr id="ans1_33" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('33')">
                    <span style="margin:0 10px; color:red;">▼</span>시디즈 의자를 사용하다가 실수로 부품이 파손 되었습니다. A/S 가능한가요?<span style="float:right;margin:0 10px;color:#000;">[ A/S ]</span></td>
            </tr>
            <tr id="ans2_33" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>고객의 귀책사유로 발생한 부분에 대해서는 유상으로 서비스를 진행하고 있습니다.  <br><br>고객센터(1577-5674) 또는 홈페이지의 [A/S문의]로 접수하시면 담당자가 파손내용을 확인하여 <br>부품별 조치금액을 안내해 드리고 있습니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_34" class="qst">
                <td class="question1" onclick="show('34')">
                    <span style="margin:0 10px; color:#fff;">▶</span>유상서비스 처리 기준은 어떻게 되나요?<span style="float:right;margin:0 10px;">[ A/S ]</span></td>
            </tr>
            <tr id="ans1_34" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('34')">
                    <span style="margin:0 10px; color:red;">▼</span>유상서비스 처리 기준은 어떻게 되나요?<span style="float:right;margin:0 10px;color:#000;">[ A/S ]</span></td>
            </tr>
            <tr id="ans2_34" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>유상서비스 고객이 서비스 처리비용을 부담하는 것으로 그 기준은 다음과 같습니다.  <br><br>1) 보증기간이 경과된 제품  <br>2) 고객의 취급 부주의 및 고의적 결함 제품  <br>3) 고객이 사용 중 천재지변(수해,화재,지진)으로 인한 결함 제품  <br>4) 출고제품의 변형 또는 지정 서비스점 이외의 사람이 수리한 제품  <br>5) 제조회사의 책임이 없는 제품  <br>6) 기타 고객이 과실을 인정한 경우  <br><br>※ 유상금액은 부품가격표에 준하며, 기타의 경우 소비자피해보상 규정에 준합니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_35" class="qst">
                <td class="question1" onclick="show('35')">
                    <span style="margin:0 10px; color:#fff;">▶</span>오래전 구입한 제품인데, 하자가 나서 A/S를 신청하니 단종된 제품이라고 합니다.<span style="float:right;margin:0 10px;">[ A/S ]</span></td>
            </tr>
            <tr id="ans1_35" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('35')">
                    <span style="margin:0 10px; color:red;">▼</span>오래전 구입한 제품인데, 하자가 나서 A/S를 신청하니 단종된 제품이라고 합니다.<span style="float:right;margin:0 10px;color:#000;">[ A/S ]</span></td>
            </tr>
            <tr id="ans2_35" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>저희 제품의 무상보증기간은 1년 입니다.  <br><br>단종된 제품이라 하더라도 A/S용 비축자재(약 3년)가 있으므로, 서비스를 받으실 수 있습니다.  <br><br>일부 사양이 변경되었다면 구사양으로는 A/S가 불가능하며, 비슷한 형태의 신사양 부품으로 <br>교체가 가능합니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_36" class="qst">
                <td class="question1" onclick="show('36')">
                    <span style="margin:0 10px; color:#fff;">▶</span>회원정보를 변경하고 싶습니다. 어떻게 해야 하나요?<span style="float:right;margin:0 10px;">[ 기타 ]</span></td>
            </tr>
            <tr id="ans1_36" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('36')">
                    <span style="margin:0 10px; color:red;">▼</span>회원정보를 변경하고 싶습니다. 어떻게 해야 하나요?<span style="float:right;margin:0 10px;color:#000;">[ 기타 ]</span></td>
            </tr>
            <tr id="ans2_36" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>[마이페이지]의 [회원정보 변경] 메뉴를 이용하시면 됩니다.  <br><br>회원 정보는 언제든지 수정이 가능하나 회원ID는 수정이 불가합니다.  <br>수정된 사항은 즉시 반영됩니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_37" class="qst">
                <td class="question1" onclick="show('37')">
                    <span style="margin:0 10px; color:#fff;">▶</span>ID와 PW를 변경하고 싶습니다.<span style="float:right;margin:0 10px;">[ 기타 ]</span></td>
            </tr>
            <tr id="ans1_37" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('37')">
                    <span style="margin:0 10px; color:red;">▼</span>ID와 PW를 변경하고 싶습니다.<span style="float:right;margin:0 10px;color:#000;">[ 기타 ]</span></td>
            </tr>
            <tr id="ans2_37" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p>시디즈의 회원 ID는 변경할 수 없음을 양해해 주시기 바랍니다. <br><br>PW는 로그인 후 [마이페이지]로 들어가셔서 [회원정보 변경] 메뉴를 클릭하신 후, <br>새 비밀번호를 등록하시고 확인버튼을 클릭하시면 변경됩니다.<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            <tr id="qst_38" class="qst">
                <td class="question1" onclick="show('38')">
                    <span style="margin:0 10px; color:#fff;">▶</span>ID와 PW를 분실했습니다.<span style="float:right;margin:0 10px;">[ 기타 ]</span></td>
            </tr>
            <tr id="ans1_38" style="display:none;" class="ans1">	
                <td class="question2" onclick="show('38')">
                    <span style="margin:0 10px; color:red;">▼</span>ID와 PW를 분실했습니다.<span style="float:right;margin:0 10px;color:#000;">[ 기타 ]</span></td>
            </tr>
            <tr id="ans2_38" style="display:none;" class="ans2">		
                <td style="padding:10px 35px;">
                <p><span style="font-size: 10pt;">화면 상단의 로그인을 클릭하시면 ID/PW 찾기를 하실 수 있습니다.&nbsp;</span><br></p><p><br>ID는 이름과 휴대전화번호, 생년월일을 입력하시면 ID를 찾으실 수 있습니다. </p><p><br>PW는 이름, 아이디, 이메일 주소를 입력하시면 임시 비밀번호가 팝업 창으로 나타납니다.&nbsp;</p><p><br>※ PW(비밀번호) 찾기는 PC에서만 가능합니다. (모바일에서 불가능)&nbsp;<br></p></td>
            </tr>
            <tr><td class="h5"></td></tr>	
            </tbody></table>
