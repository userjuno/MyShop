...
<!--                 
            ...
            <div id="tab" class="pabs" style="margin-left: 16%; margin-bottom: -7%;">
                ...
                <a href="clien_FQA_6.jsp" style="background-color:#F04130;">A/S</a>
            ...
            <h2><img style="margin-left:38%;" src="https://www.sidiz.com/img/tl2/tl2_faq_A01006.jpg" alt=""></h2>
            
            <table id="faqtbl">
                <tbody><tr id="qst_31" class="qst">
                    <td class="question1" onclick="show('31')">
                        <span style="margin:0 10px; color:#fff;">▶</span>A/S 접수를 했는데 언제쯤 조치가 되나요?</td>
                </tr>
                <tr id="ans1_31" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('31')">
                        <span style="margin:0 10px; color:red;">▼</span>A/S 접수를 했는데 언제쯤 조치가 되나요?</td>
                </tr>
                ...
                <tr id="qst_32" class="qst">
                    <td class="question1" onclick="show('32')">
                        <span style="margin:0 10px; color:#fff;">▶</span>A/S 는 어떻게 신청하나요?</td>
                </tr>
                <tr id="ans1_32" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('32')">
                        <span style="margin:0 10px; color:red;">▼</span>A/S 는 어떻게 신청하나요?</td>
                </tr>
                ...
                <tr id="qst_33" class="qst">
                    <td class="question1" onclick="show('33')">
                        <span style="margin:0 10px; color:#fff;">▶</span>시디즈 의자를 사용하다가 실수로 부품이 파손 되었습니다. A/S 가능한가요?</td>
                </tr>
                <tr id="ans1_33" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('33')">
                        <span style="margin:0 10px; color:red;">▼</span>시디즈 의자를 사용하다가 실수로 부품이 파손 되었습니다. A/S 가능한가요?</td>
                </tr>
                ...
                <tr id="qst_34" class="qst">
                    <td class="question1" onclick="show('34')">
                        <span style="margin:0 10px; color:#fff;">▶</span>유상서비스 처리 기준은 어떻게 되나요?</td>
                </tr>
                <tr id="ans1_34" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('34')">
                        <span style="margin:0 10px; color:red;">▼</span>유상서비스 처리 기준은 어떻게 되나요?</td>
                </tr>
                ...
                <tr id="qst_35" class="qst">
                    <td class="question1" onclick="show('35')">
                        <span style="margin:0 10px; color:#fff;">▶</span>오래전 구입한 제품인데, 하자가 나서 A/S를 신청하니 단종된 제품이라고 합니다.</td>
                </tr>
                <tr id="ans1_35" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('35')">
                        <span style="margin:0 10px; color:red;">▼</span>오래전 구입한 제품인데, 하자가 나서 A/S를 신청하니 단종된 제품이라고 합니다.</td>
                </tr>
