                   ...
                   <ul >
                    ...
                    <div class="min_FAQ">
                        ...
                        <ul>
                            ...
                            <li><a href="userboardList.ubo">mypage</a></li>
                        </ul>
                    </div>
                </div>
            </div> 
...
<section id="listForm" style="width:1500px">
...
<form method="post">
      <table style="width:1400px">
        ...
        <tr>
        	...
        	<td>
        		<input type="checkbox" id="remove" name="remove" value="${cart.goods_name }"/>
        	</td>
             <td>
             ...
             <td>
             <img class="or_img" src = "images/${cart.img }" id ="orderImage"/>
            </td>
             
             <td>${cart.goods_name}</td>
             <td>${cart.buyer}</td>
             <td>${cart.addr}</td>
             <td>${cart.addr_more}</td>
             <td>${cart.zipcode}</td>
             <td>01033811354</td>
             <td>2500</td>
             <td>${cart.price}</td>
             ...
             <td><input style="text-overflow: ellipsis; border:0;" value="${cart.memo}"></td>
         ...
         <h1>구매 취소는 구입으로 부터 3일이 지나지 않아야 합니다</h1>
         	<input type="submit" value="구매 취소" class="re_o" formaction="dogOrderRemove.dog"/>
         </td>
      </tr>
