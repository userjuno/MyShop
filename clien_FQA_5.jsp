    ...
    <div class="contents" style="padding-top: 70px;">
        ...
        <div id="contents">
            ...
            <div id="tab" class="pabs" style="margin-left: 16%; margin-bottom: -7%;">
                ...
                <a href="clien_FQA_5.jsp" style="background-color:#F04130;" >회원가입/탈퇴</a>    
            ...
            <h2><img style="margin-left:38%;" src="https://www.sidiz.com/img/tl2/tl2_faq_A01005.jpg" alt=""></h2>
            
            <table id="faqtbl">
                <tbody><tr id="qst_26" class="qst">
                    <td class="question1" onclick="show('26')">
                        <span style="margin:0 10px; color:#fff;">▶</span>탈퇴 후 재가입이 가능한가요?</td>
                </tr>
                <tr id="ans1_26" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('26')">
                        <span style="margin:0 10px; color:red;">▼</span>탈퇴 후 재가입이 가능한가요?</td>
                </tr>
                ...
                <tr id="qst_28" class="qst">
                    <td class="question1" onclick="show('28')">
                        <span style="margin:0 10px; color:#fff;">▶</span>회원 탈퇴 후 개인정보는 어떻게 관리되나요?</td>
                </tr>
                <tr id="ans1_28" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('28')">
                        <span style="margin:0 10px; color:red;">▼</span>회원 탈퇴 후 개인정보는 어떻게 관리되나요?</td>
                </tr>
                ...
                <tr id="qst_29" class="qst">
                    <td class="question1" onclick="show('29')">
                        <span style="margin:0 10px; color:#fff;">▶</span>회원 가입할 때 어떤 정보를 입력해야 하나요?</td>
                </tr>
                <tr id="ans1_29" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('29')">
                        <span style="margin:0 10px; color:red;">▼</span>회원 가입할 때 어떤 정보를 입력해야 하나요?</td>
                </tr>
                ...
                <tr id="qst_30" class="qst">
                    <td class="question1" onclick="show('30')">
                        <span style="margin:0 10px; color:#fff;">▶</span>회원 탈퇴는 어떻게 하나요?</td>
                </tr>
                <tr id="ans1_30" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('30')">
                        <span style="margin:0 10px; color:red;">▼</span>회원 탈퇴는 어떻게 하나요?</td>
                </tr>
