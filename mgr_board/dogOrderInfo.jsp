...
<%@page import="mgrvo.UserBean"%>
<%@page import="dao.MgrBoardDAO"%>
...
<%
ArrayList<UserBean> articleList=(ArrayList<UserBean>)request.getAttribute("articleList");
%>
...
%>
	...
	%>
			<tr class="M_t" style="height:40px;">
				...
				<td>
					<%=articleList.get(i).getAddr()%>
				</td>
				<td>
					<%=articleList.get(i).getPhone()%>
				</td>
			</tr>
			<%}} %>
		</table>
