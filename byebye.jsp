...
<li style="padding: 15%;"><a style="color: white;width:80px" href="freeboardList.fbo">질문게시판</a></li>
    ...
    <div class="contents" style="padding-top: 70px;">
            ...
            <h1 class="M_header">회원 탈퇴</h1>
            <div class="up_form">
                <form name="byeFrm" method="post" action="memberbye.jsp" >
                    		
                    <input name ="pwd" style="margin: 2.5% 0;" type="password" id="M_t" class="Mo_pw3" placeholder="비밀번호">
                    <input type="button" id="M_t" style="text-align: center;" onclick="inputCheck()" class="jbtn_3" value="회원 정보 조회">
                </form>    
            </div>
