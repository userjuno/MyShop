...
<!--                 
            ...
            <div id="tab" class="pabs" style="margin-left: 16%; margin-bottom: -7%;">
                ...
                <a href="clien_FQA_7.jsp" style="background-color:#F04130;">기타</a>
        
        
            </div>
            <hr>
            <div class="bar"><p></p></div>
            <h2><img style="margin-left:38%;" src="https://www.sidiz.com/img/tl2/tl2_faq_A01007.jpg" alt=""></h2>
            
            <table id="faqtbl">
                <tbody><tr id="qst_36" class="qst">
                    <td class="question1" onclick="show('36')">
                        <span style="margin:0 10px; color:#fff;">▶</span>회원정보를 변경하고 싶습니다. 어떻게 해야 하나요?</td>
                </tr>
                <tr id="ans1_36" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('36')">
                        <span style="margin:0 10px; color:red;">▼</span>회원정보를 변경하고 싶습니다. 어떻게 해야 하나요?</td>
                </tr>
                ...
                <tr id="qst_37" class="qst">
                    <td class="question1" onclick="show('37')">
                        <span style="margin:0 10px; color:#fff;">▶</span>ID와 PW를 변경하고 싶습니다.</td>
                </tr>
                <tr id="ans1_37" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('37')">
                        <span style="margin:0 10px; color:red;">▼</span>ID와 PW를 변경하고 싶습니다.</td>
                </tr>
                ...
                <tr id="qst_38" class="qst">
                    <td class="question1" onclick="show('38')">
                        <span style="margin:0 10px; color:#fff;">▶</span>ID와 PW를 분실했습니다.</td>
                </tr>
                <tr id="ans1_38" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('38')">
                        <span style="margin:0 10px; color:red;">▼</span>ID와 PW를 분실했습니다.</td>
                </tr>
