...
<li style="padding: 15%;"><a style="color: white;width:80px" href="freeboardList.fbo">질문게시판</a></li>
	...
	<section id="articleForm">
		<section id="basicInfoArea"  style="background-color:black;line-height:40px ;">
			제 목 :
			<%=article.getBOARD_SUBJECT()%>
			<input type="hidden" name="q_name" value="<%=article.getBOARD_NUM() %>"> 
		</section>
		<section id="articleContentArea" style="background-color:white;padding:3%; padding-bottom:0;text-align:left">
	...
	<section id="commandList">
		<a
			href="userboardReplyForm.ubo?board_num=<%=article.getBOARD_NUM() %>&page=<%=nowPage%>">
			[답변] </a> <a
			href="userboardUpdateForm.ubo?board_num=<%=article.getBOARD_NUM() %>&page=<%=nowPage%>">
			[수정] </a> <a
			href="userboardDeleteForm.ubo?board_num=<%=article.getBOARD_NUM() %>&page=<%=nowPage%>">
			[삭제] </a> <a href="userboardList.ubo?page=<%=nowPage%>">[목록]</a>&nbsp;&nbsp;
	</section>
	</div>
</body>
