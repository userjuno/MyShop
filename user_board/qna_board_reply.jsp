...
<li style="padding: 15%;"><a style="color: white;width:80px" href="freeboardList.fbo">질문게시판</a></li>
   ...
   <section id="writeForm">
      <h2>게시판글등록</h2>
      <form action="userboardReplyPro.ubo" method="post" name="boardform">
         ...
         <table>
               ...
               <input type="hidden" name="BOARD_NAME"
                  id="BOARD_NAME" value="admin"/></td>
               <input type="hidden" name="q_name" value="<%=request.getParameter("board_num")%>">
