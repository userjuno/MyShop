...
<li style="padding: 15%;"><a style="color: white;width:80px" href="freeboardList.fbo">질문게시판</a></li>
    ...
    <div class="contents">
       <div class="b_pan">
       		<div class="s_pan">
       			<ul>
       				<li><a class="my_tag" href="userboardList.ubo">1:1 문의</a></li>
       				<li><a class="my_tag" href="dogOrderList.dog">구매내역 확인</a></li>
       				<li><a class="my_tag" href="dogCartList.dog">장바구니</a></li>
       			</ul>
       		</div>
       		<div class = "m_pan">
...
%>
	...
	<a style="background-color:rgb(233,233,233);width:100px;height:20px;padding:13px" href="userboardWriteForm.ubo	">게시판글쓰기</a>
	</div>
