...
<body onLoad="regFrm.id.focus();msg()">
    ...
    <div class="fixed">
        <div class="header">
            ...
            <a class="back" href="bag.jsp"><img src="image/back.PNG"></a>
    ...
    <div class="contents" style="margin-top: 5%;">
        <div class="slideshow">
            <div class="slideshow-slides">
                <a href="#" class="slide" id="slide-1"><img src="image/slide-1.jpg" alt="" width="1600" height="465"></a>
                <a href="#" class="slide" id="slide-2"><img src="image/slide-2.jpg" alt="" width="1600" height="465"></a>
                <a href="#" class="slide" id="slide-3"><img src="image/slide-3.jpg" alt="" width="1600" height="465"></a>
                <a href="#" class="slide" id="slide-4"><img src="image/slide-4.jpg" alt="" width="1600" height="465"></a>
    ...
    $(".notice").click(function(){
        var dis1=$(this).next();
        var state1=dis1.css('display');
        if(state1=='none'){
            dis1.css('display','table-row')
        }
        else{
   ...
   $('.slideshow').each(function(){
        ...
        $('#1').html('도메인 신규 등록 25% 할인');
        $('#2').html('리눅스 웹 호스팅 시작가 50% 할인');
        $('#3').html('더 실속 있는 서버호스팅');
        $('#4').html('용량 걱정없는 무제한 웹메일');
        $('#5').html('국내 최대 규모의 무료호스팅')
