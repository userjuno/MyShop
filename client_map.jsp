...
<head>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=666fb92af400c54390d545c758738c47"></script>
...
<style>
   ...
   .contents{
    ...
    .sin{
        display: inline-block;
        padding: 12px 35px;border: 1px solid white;
        /* border: 1px solid red; */
    }
    .find{
        display: inline-block;
    ...
    .custom_zoomcontrol {position:absolute;top:500px;right:10px;width:36px;height:80px;overflow:hidden;z-index:99;background-color:#fff} 
...
<li style="padding: 15%;"><a style="color: white;width:80px" href="freeboardList.fbo">질문게시판</a></li>
    ...
    <div class="contents" style="padding-top:70px;">
        ...
        <article>
			<h1 style="margin-left: 58%; margin-bottom: 5%; margin-top: 5%;">매장 위치 안내</h1>
			<div id="map">
...
%>		$(".My").text("MGR");
  ...
  <%}%>
    ...
    var markers = [
        {
            position: new kakao.maps.LatLng(37.5428619, 126.6771859)
        },
        {
            position: new kakao.maps.LatLng(37.5428619, 126.6771859), 
            text: '여기가 매장 위치입니다!' // text 옵션을 설정하면 마커 위에 텍스트를 함께 표시할 수 있습니다     
        }
    ];
    var container = document.getElementById('map'); 
    var options = { 
        center: new kakao.maps.LatLng(37.5428619, 126.6771859), 
        level: 2,
        marker: markers 
    };
