...
<style type="text/css">
	 body, html{
       ...
       .td_right{
       		...
       		width:100px;
       	border-radius-left-top:50%;
       	border-radius-left-bottom:50%;
       }
</style>
</head>
<script>
   ...
   <div class="aside_wrap">
        ...
        <div class="aside_font">
            ...
            <ul style="text-align: center;font-family: 'Gugi', cursive; display: block;width: 120px;color: white;left: 29%;position: relative;">
                ...
                <li style="padding: 25%;"><a style="color: white;" href="freeboardList.fbo">자유게시판</a></li>
            </ul>
        </div>
      ...
      String pw = request.getParameter("pwd");
      	...
      	if(bean==null){
      		...
      		<% 
	    		...
	    		<h1 class=M_t style="text-align:center ;border:0;margin-left:84px;"><%=bean.getName()%>님의 정보 조회 </h1>
	      		<table style="width:1000px; padding : 15px" >
	            <tr>
	               <td class="td_right" style="padding-left:40px;"><label for="BOARD_NAME">아이디</label></td>
	               <td class="td_left"><label class="M_t" for="BOARD_NAME"><%=bean.getId() %></label></td>
	             
	            </tr>
	            <tr>
	               <td class="td_right" style="padding-left:40px;"><label for="BOARD_PASS">이름</label></td>
	                <td class="td_left"><label class="M_t" for="BOARD_NAME"><%=bean.getName() %></label></td>
	            </tr>
	            <tr>
	               <td class="td_right" style="padding-left:40px;"><label for="BOARD_SUBJECT">전화번호</label></td>
	                <td class="td_left"><label class="M_t" for="BOARD_NAME"><%=bean.getPhone() %></label></td>
	            </tr>
	            <tr>
	               <td class="td_right" style="padding-left:40px;"><label for="BOARD_CONTENT">우편번호</label></td>
	                <td class="td_left"><label class="M_t" for="BOARD_NAME"><%=bean.getZipcode() %></label></td>
	            </tr>
	            <tr>
	               <td class="td_right" style="padding-left:40px;"><label for="BOARD_CONTENT">주소</label></td>
	                <td class="td_left"><label class="M_t" for="BOARD_NAME"><%=bean.getAddress() %></label></td>
	            </tr>
	            <tr>
	               <td class="td_right" style="padding-left:40px;"><label for="BOARD_CONTENT">상세주소</label></td>
	                <td class="td_left"><label class="M_t" for="BOARD_NAME"><%=bean.getAddr_more() %></label></td>
	            </tr>
	         </table>
	      	<%
      	}
