...
<li style="padding: 15%;"><a style="color: white;width:80px" href="freeboardList.fbo">질문게시판</a></li>
   ...
   <section id="writeForm">
      <h2>게시판글수정</h2>
      <form action="boardUpdatePro.bo" method="post" name="boardform">
         ...
         <table>
            <tr>
               ...
               <td class="td_right"><input type="text" name="BOARD_NAME" value="<%=article.getBOARD_NAME() %>"
                  id="BOARD_NAME" /></td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td class="td_right"><input name="BOARD_SUBJECT" style="width:99%;" type="text"
                  id="BOARD_SUBJECT" /></td>
            </tr>
            <tr>
