...
<li style="padding: 15%;"><a style="color: white;width:80px" href="freeboardList.fbo">질문게시판</a></li>
 ...
 <%
	...
	<section id="writeForm">
		<h2>자유게시판 글 등록</h2>
		<form action="freeboardWritePro.fbo" method="post"
			...
			<table>
				<tr>
					...
					<td class="td_right">
					<input type="hidden" id="BOARD_NAME" name="BOARD_NAME" value=<%=a%>>
					<label id="BOARD_NAME" name="BOARD_NAME" value=<%=a%>><%=a%></label>
						</td>
				</tr>
				<tr>
					<td class="td_left"><label for="BOARD_PASS">비밀번호</label></td>
					<td class="td_right"><input style="width:45%" name="BOARD_PASS" type="password"
						id="BOARD_PASS" required="required" /></td>
				</tr>
				<tr>
					<td class="td_left"><label for="BOARD_SUBJECT">제 목</label></td>
					<td class="td_right"><input style="width:80%" name="BOARD_SUBJECT" type="text"
						id="BOARD_SUBJECT" required="required" /></td>
				</tr>
				<tr>
					<td class="td_left" ><label for="BOARD_CONTENT">내 용</label></td>
					<td style="padding:0;"><textarea id="BOARD_CONTENT" name="BOARD_CONTENT"
			...
			<h1 style="margin-top: 5%; margin-bottom: 5%;"></h1>
