    ...
    <div class="contents" style="padding-top: 70px;">
        ...
        <div id="contents">
            ...
            <div id="tab" class="pabs" style="margin-left: 16%; margin-bottom: -7%;">
                ...
                <a href="clien_FQA_3.jsp"style="background-color:#F04130;">교환/반품</a>
            ...
            <h2><img style="margin-left:38%;" src="https://www.sidiz.com/img/tl2/tl2_faq_A01003.jpg" alt=""></h2>
            
            <table id="faqtbl">
                <tbody><tr id="qst_16" class="qst">
                    <td class="question1" onclick="show('16')">
                        <span style="margin:0 10px; color:#fff;">▶</span>상품을 받았는데 상품이 불량입니다. 교환해주세요.</td>
                </tr>
                <tr id="ans1_16" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('16')">
                        <span style="margin:0 10px; color:red;">▼</span>상품을 받았는데 상품이 불량입니다. 교환해주세요.</td>
                </tr>
                ...
                <tr id="qst_17" class="qst">
                    <td class="question1" onclick="show('17')">
                        <span style="margin:0 10px; color:#fff;">▶</span>시디즈 의자는 반품이 안되나요?</td>
                </tr>
                <tr id="ans1_17" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('17')">
                        <span style="margin:0 10px; color:red;">▼</span>시디즈 의자는 반품이 안되나요?</td>
                </tr>
                ...
                <tr id="qst_18" class="qst">
                    <td class="question1" onclick="show('18')">
                        <span style="margin:0 10px; color:#fff;">▶</span>교환/ 반품은 어떻게 진행되나요?</td>
                </tr>
                <tr id="ans1_18" style="display:none;" class="ans1">	
                    <td class="question2" onclick="show('18')">
                        <span style="margin:0 10px; color:red;">▼</span>교환/ 반품은 어떻게 진행되나요?</td>
                </tr>
