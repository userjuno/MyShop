...
<body onLoad="regFrm.id.focus();msg()">
    ...
    <div class="aside_wrap">
        ...
        <div class="aside_font">
            ...
            <ul style="text-align: center;font-family: 'Gugi', cursive; display: block;width: 120px;color: white;left: 29%;position: relative;">
                <li style="padding: 25%;"><a style="color: white;"  href="boardList.bo">About</a></li>
    ...
    <div class="header">
        ...
        <div class="header3">
            ...
            <a class="mypage" style="display: none;"><p class="My">mypage</p></a>
    ...
    <div class="contents">
        <h1 style="text-align: center;margin: 0 auto; padding-bottom: 5%;"></h1>
        <p style="padding-bottom: 1%; padding-left: 1%;">shop</p>
       <div><a href="goodsbox.jsp"><img style="width:217px; height: 217px; padding-left: 3%;" src="https://cdn.imweb.me/thumbnail/20161229/586468746511b.jpg">
       </a><p style="padding-left: 3.2%;"><a href="goodsbox.jsp">Brooklyn Brine Fennel Beets</a><br>7000원</p>
