...
<li style="padding: 15%;"><a style="color: white;width:80px" href="freeboardList.fbo">질문게시판</a></li>
    ...
    <div class="contents" style="margin-top:7%">
    <form action="dogPay.dog" method="post" name = "writeForm" enctype="multipart/form-data">
   <%
	...
	<table>
		<tr>
			<td class="f_l">
				...
				<img class="pay_img" src="images/${dog.image}" id="productImage"/>
				<input type="hidden" name="dog_img" value="${dog.image}">
			</td>
			<td class="f_l">
				<div class="infotext">
				<p>상표 : ${dog.item_name}</p>
				<input type="hidden" name="item_name" value="${dog.item_name}" >
				<p>가격 : ${dog.price}</p>
				<input type="hidden" name="item_price" value="${dog.price}" >
				<p>원산지 : ${dog.made}</p>
				<p>배송비 : ${dog.trans_pay }</p>
				
				<p>수량 : <input type="text" id="pay_c" placeholder="수량을 입력하세요" name="pay_count" value="1"></p>
		...
		<nav id = "commandList">
			...
			<a href="dogCartAdd.dog?id=${dog.item_name}&b=<%=b%>">장바구니에담기</a>
